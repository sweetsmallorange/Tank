...
def plot_basin_data(df, year, basin_id, output_folder):
    ...
    colors = ['#9467bd', '#76b7b2', '#f28e2b', '#e15759', '#9c755f']  # 原配色
    ...
    ax.plot(df.index, df['TRM-Tank'], label='TRM-Tank', color=colors[3], alpha=0.95, linewidth=2.8, linestyle='-')
    ax.plot(df.index, df['obs_tci'], label='Runoff Observation', color=colors[4], alpha=0.95, linewidth=2.8,
...
def main():
    ...
    for basin_id in basin_ids:
        ...
        if basin_id not in ["maurer_8164300", "maurer_8050800", "maurer_8176900"]:
            continue
